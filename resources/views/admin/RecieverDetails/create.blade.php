...
@section('title')
Add Reciver Details - Admin Panel
@endsection
        ...
        <div class="row justify-content-center my-3">
            <div class="col-md-8">
                <ol class="breadcrumb my-4 ">
                    ...
                    <li class="breadcrumb-item active">Add Reciver Details</li>
                </ol>
                <div class="card mt-2">
                    <div class="card-header text-center">Add Reciver Details</div>
                    @include('admin.layouts.parts.messages')
                    <div class="card-body">
                        <form action="{{route('admin.reciver.store')}}" method="post" >
                            <div class="row">
                                @csrf
                                <div class="col-md-10 mx-auto">
                                    ...
                                    <button type="submit" class="btn btn-dark">Add Reciver Details</button>
                                </div>
                            </div>
                        </form>
                    </div>
