...
@section('title')
Add Schedule No Four Data - Admin Panel
@endsection
        ...
        <div class="row justify-content-center my-3">
            <div class="col-md-10">
                <ol class="breadcrumb my-4 ">
                    ...
                    <li class="breadcrumb-item active">Add Schedule Four</li>
                </ol>

                <div class="card mt-4 mb-2">
                    <div class="card-header text-center"><b>Add Schedule No Four</b></div>
                    @include('admin.layouts.parts.messages')
                    <div class="card-body">
                        <form action="{{route('admin.suchifour.store')}}" method="post" >
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="PerInterest" id="title" required>
                                </div>
