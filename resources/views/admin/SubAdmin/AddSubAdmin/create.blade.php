        ...
        <div class="col-md-10 ">
            <div>
                <ol class="breadcrumb my-4 ">
                    <li class="breadcrumb-item"><a href="{{route('subadmin')}}">সাব অ্যাডমিন </a></li>

                </ol>
                <div class="card-header text-center"> সাব অ্যাডমিন রেজিস্টার করুন </div>
                @include('admin.layouts.parts.messages')
                <div class="card-body">
                    <form method="POST" action="{{route('subadminstore')}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" cols="10" rows="5" value="{{ old('address') }}" required autocomplete="address"></textarea>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">{{ __('পাসওয়ার্ড') }}<span class="text-danger">*</span></label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('কনফার্ম পাসওয়ার্ড') }}<span class="text-danger">*</span></label>
