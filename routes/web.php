...
Route::group(['prefix' => 'admin', 'middleware' => 'authAdmin'], function () {
    ...
    // Admin Part Route
    Route::get('/All-Deed-Copy', [AdminDeedCopyController::class, 'index'])->name('DeedCopyTypes');
    Route::get('/deed-copy/edit/{$id}', [AdminDeedCopyController::class, 'edit'])->name('editCopydeed');
